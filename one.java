...
//     // Method to generate the exception (unsafe)
...
//     // Method to generate NumberFormatException (unsafe)
//     public static void generateException(String text) {
...
//         System.out.println("\n=== Generating Exception ===");
//         try {
//             generateException(input); // Unsafe call
//         } catch (NumberFormatException e) {
//             System.out.println("Exception caught in main: " + e.getMessage());
//         }

//         System.out.println("\n=== Handling Exception Gracefully ===");
//         handleException(input); // Safe call with internal handling
